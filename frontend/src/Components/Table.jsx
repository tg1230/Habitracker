...
export default function SimpleTable() {
  ...
  async function sampleFunc() {
    let response = await fetch("/api/Habit");
  ...
  function incrementStreak(id, index)
  {

    let dataCopy = data[index];
    dataCopy.streak += 1;
    // console.log(data[index].streak)
    console.log(dataCopy)
   //upDateData({...data[index], dataCopy});
   console.log({dataCopy, ...data[index]})
          ...
          <Table className={classes.table} aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center">Streak Number</TableCell>
